# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE TOTALPLAY
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Totalplay_automatizada.pptx'
# (vive directamente en Automatizaciones_PPT, sin subcarpeta).
# El reporte cubre: NPS Grupo Salinas (slide 4, shapes SL; usa Resonsable_N3
# como responsable, fiel al script original), NPS Grupo Totalplay (slide 6,
# shapes TP) y menciones Top 10 con rubro Tabla_PRO/PAS/DET_MENS_TP
# (slides 7-9).
#
# NOTA: los bloques NPS filtran TIPO == 'Normal'; las menciones no,
...
TEMPLATE_PPTX = r'E:\Users\954108\Desktop\Satisfaccion  y Asuntos Publicos\Automatizaciones_PPT\IPN_Colaboradores_Totalplay_automatizada.pptx'
OUTPUT_PPTX = 'Reporte_Totalplay.pptx'
...
BLOQUES_NPS = [
    ...
    # el responsable de la etiqueta sale de Resonsable_N3, fiel al original)
    {'slide_index': 3, 'nivel_col': 'Agrupador', 'resp_col': 'Resonsable_N3',
    ...
    # Slide 6: Grupo Totalplay por Nivel 3 (filtra TIPO Normal + Agrupador)
    {'slide_index': 5, 'nivel_col': 'Nivel 3', 'resp_col': 'Resonsable_N3',
     'filtros': [('TIPO', 'Normal'), ('Agrupador', 'GRUPO TOTALPLAY')],
     'etiqueta_total': 'Totalplay',
     'grafico_barras': 'Grafico_bar_TP', 'grafico_dona': 'Grafico _don_TP',
     'tabla_dif': 'Tabla_DIF_TP', 'tabla_anterior': 'Tabla_ANTERIO_TP', 'sufijo_dona': 'TP'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slides 7, 8 y 9)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == GRUPO TOTALPLAY.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'GRUPO TOTALPLAY')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor',  'tabla': 'Tabla_PRO_MENS_TP'},
    {'slide_index': 7, 'categoria': 'Pasivo',    'tabla': 'Tabla_PAS_MENS_TP'},
    {'slide_index': 8, 'categoria': 'Detractor', 'tabla': 'Tabla_DET_MENS_TP'},
]

# (Lista usada por el matcheo de colores; compartida con el proyecto principal)
GRUPOS_ORDENADOS = ['GRUPO TOTALPLAY']
