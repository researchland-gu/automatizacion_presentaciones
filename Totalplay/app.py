# ==============================================================================
# APP WEB DEL REPORTE TOTALPLAY
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Totalplay):
...
st.set_page_config(page_title="Reporte Totalplay", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Totalplay")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Totalplay_{trimestre} {anio}.pptx",
    )
