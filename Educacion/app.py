# ==============================================================================
# APP WEB DEL REPORTE EDUCACIÓN
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Educacion):
...
st.set_page_config(page_title="Reporte Educación", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Educación")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Educacion_{trimestre} {anio}.pptx",
    )
