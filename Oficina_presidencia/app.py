# ==============================================================================
# APP WEB DEL REPORTE OFICINA DE LA PRESIDENCIA
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Oficina_presidencia):
...
st.set_page_config(page_title="Reporte Oficina de la Presidencia", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Oficina de la Presidencia")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Oficina de la Presidencia_{trimestre} {anio}.pptx",
    )
...
with st.expander("Opciones avanzadas (plantilla)"):
    ...
    st.caption("Este reporte no actualiza archivos de Excel históricos.")
