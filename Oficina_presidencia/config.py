# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE OFICINA DE LA PRESIDENCIA
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Oficina Presidencia_automatizada.pptx'.
# Todo el reporte (slides 4, 6 y 7) se genera sobre esa plantilla:
# Grafico_bar_SL, Tabla_DIF_SL, Tabla_ANTERIO_SL, 'Grafico _don_SL' y
# tarjetas SL (slide 4); Grafico_bar_OP, Tabla_DIF_OP, Tabla_ANTERIO_OP,
# 'Grafico _don_OP' y tarjetas OP (slide 6); y la tabla de menciones de
# promotores Tabla_PRO_MENS_OP (slide 7).
#
...
TEMPLATE_PPTX = r'E:\Users\954108\Desktop\Satisfaccion  y Asuntos Publicos\Automatizaciones_PPT\IPN Colaboradores\IPN_Colaboradores_Oficina Presidencia_automatizada.pptx'
OUTPUT_PPTX = 'Reporte_Oficina_Presidencia.pptx'
...
BLOQUES_NPS = [
    ...
    # Slide 6: Oficina de la Presidencia por Nivel 3 (filtra TIPO Normal + Agrupador)
    {'slide_index': 5, 'nivel_col': 'Nivel 3', 'resp_col': 'Resonsable_N3',
     'filtros': [('TIPO', 'Normal'), ('Agrupador', 'OFICINA DE LA PRESIDENCIA')],
     'etiqueta_total': 'Oficina de la Presidencia',
     'grafico_barras': 'Grafico_bar_OP', 'grafico_dona': 'Grafico _don_OP',
     'tabla_dif': 'Tabla_DIF_OP', 'tabla_anterior': 'Tabla_ANTERIO_OP', 'sufijo_dona': 'OP'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slide 7, solo Promotores)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == OFICINA DE LA PRESIDENCIA.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'OFICINA DE LA PRESIDENCIA')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor', 'tabla': 'Tabla_PRO_MENS_OP'},
]

# (Lista usada por el matcheo de colores; compartida con el proyecto principal)
GRUPOS_ORDENADOS = ['OFICINA DE LA PRESIDENCIA']
