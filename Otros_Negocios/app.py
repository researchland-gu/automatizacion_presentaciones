# ==============================================================================
# APP WEB DEL REPORTE OTROS NEGOCIOS
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Otros_Negocios):
...
st.set_page_config(page_title="Reporte Otros Negocios", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Otros Negocios")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Otros Negocios_{trimestre} {anio}.pptx",
    )
