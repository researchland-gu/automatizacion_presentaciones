# ==============================================================================
# APP WEB DEL REPORTE TV AZTECA
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta TV_Azteca):
...
st.set_page_config(page_title="Reporte TV Azteca", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte TV Azteca")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte TV Azteca_{trimestre} {anio}.pptx",
    )
