# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE TV AZTECA
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Tv Azteca_automatizada.pptx'
# (vive directamente en Automatizaciones_PPT, sin subcarpeta).
# El reporte cubre: NPS Grupo Salinas (slide 4, shapes SL), NPS Grupo
# TV Azteca por Nivel 4 (slide 6, shapes TA) y menciones Top 10 con rubro
# Tabla_PRO/PAS/DET_MENS_TA (slides 7-9).
#
...
TEMPLATE_PPTX = r'E:\Users\954108\Desktop\Satisfaccion  y Asuntos Publicos\Automatizaciones_PPT\IPN_Colaboradores_Tv Azteca_automatizada.pptx'
OUTPUT_PPTX = 'Reporte_TV_Azteca.pptx'
...
BLOQUES_NPS = [
    ...
    # Slide 6: Grupo TV Azteca por Nivel 4 (filtra TIPO Normal + Agrupador)
    {'slide_index': 5, 'nivel_col': 'Nivel 4', 'resp_col': 'Resonsable_N4',
     'filtros': [('TIPO', 'Normal'), ('Agrupador', 'GRUPO TV AZTECA')],
     'etiqueta_total': 'Grupo TV Azteca',
     'grafico_barras': 'Grafico_bar_TA', 'grafico_dona': 'Grafico _don_TA',
     'tabla_dif': 'Tabla_DIF_TA', 'tabla_anterior': 'Tabla_ANTERIO_TA', 'sufijo_dona': 'TA'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slides 7, 8 y 9)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == GRUPO TV AZTECA.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'GRUPO TV AZTECA')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor',  'tabla': 'Tabla_PRO_MENS_TA'},
    {'slide_index': 7, 'categoria': 'Pasivo',    'tabla': 'Tabla_PAS_MENS_TA'},
    {'slide_index': 8, 'categoria': 'Detractor', 'tabla': 'Tabla_DET_MENS_TA'},
]

# (Lista usada por el matcheo de colores; compartida con el proyecto principal)
GRUPOS_ORDENADOS = ['GRUPO TV AZTECA']
