# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE DESPACHOS
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Despachos_automatizada.pptx'.
# Todo el reporte (slides 4, 6, 7, 8 y 9) se genera sobre esa plantilla,
# así que debe contener las shapes de los 5 slides: Grafico_bar_SL,
# Tabla_DIF_SL, Grafico _don_GS y tarjetas GS (slide 4); Grafico_bar_DP,
# Tabla_DIF_DP, Grafico _don_DP y tarjetas DP (slide 6); y las tablas
# Tabla_PRO/PAS/DET_MENS_DP (slides 7-9).
# ==============================================================================
...
OUTPUT_PPTX = 'Reporte_Despachos.pptx'
...
BLOQUES_NPS = [
    ...
    {'slide_index': 3, 'nivel_col': 'Agrupador', 'resp_col': 'Resonsable_N2',
     ...
     'grafico_barras': 'Grafico_bar_SL', 'grafico_dona': 'Grafico _don_GS',
     'tabla_dif': 'Tabla_DIF_SL', 'tabla_anterior': 'Tabla_ANTERIO_SL', 'sufijo_dona': 'GS'},

    # Slide 6: Despachos por Nivel 3
    {'slide_index': 5, 'nivel_col': 'Nivel 3', 'resp_col': 'Resonsable_N3',
     'filtros': [('Agrupador', 'DESPACHOS')],
     'etiqueta_total': 'Despachos - RBS',
     'grafico_barras': 'Grafico_bar_DP', 'grafico_dona': 'Grafico _don_DP',
     'tabla_dif': 'Tabla_DIF_DP', 'tabla_anterior': 'Tabla_ANTERIO_DP', 'sufijo_dona': 'DP'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slides 7, 8 y 9)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == DESPACHOS.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'DESPACHOS')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor',  'tabla': 'Tabla_PRO_MENS_DP'},
    {'slide_index': 7, 'categoria': 'Pasivo',    'tabla': 'Tabla_PAS_MENS_DP'},
    {'slide_index': 8, 'categoria': 'Detractor', 'tabla': 'Tabla_DET_MENS_DP'},
]
