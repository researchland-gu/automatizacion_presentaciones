# ==============================================================================
# APP WEB DEL REPORTE DESPACHOS
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Despacho):
...
st.set_page_config(page_title="Reporte Despachos", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Despachos")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Despachos_{trimestre} {anio}.pptx",
    )
