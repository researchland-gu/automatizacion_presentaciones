# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE NEGOCIOS FAMILIA
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Negocios Familia_automatizada.pptx'.
# Todo el reporte (slides 4, 6, 7, 8 y 9) se genera sobre esa plantilla:
# Grafico_bar_SL, Tabla_DIF_SL, Tabla_ANTERIO_SL, 'Grafico _don_SL' y
# tarjetas SL (slide 4); Grafico_bar_NF, Tabla_DIF_NF, Tabla_ANTERIO_NF,
# 'Grafico _don_NF' y tarjetas NF (slide 6); y las tablas
# Tabla_PRO/PAS/DET_MENS_NF (slides 7-9).
#
# NOTA: en este reporte los bloques NPS filtran TIPO == 'Normal' (además de
# calificación válida y Respondida == 'Si'), tal como los scripts originales.
# ==============================================================================
...
TEMPLATE_PPTX = r'E:\Users\954108\Desktop\Satisfaccion  y Asuntos Publicos\Automatizaciones_PPT\IPN Colaboradores\IPN_Colaboradores_Negocios Familia_automatizada.pptx'
OUTPUT_PPTX = 'Reporte_Negocios_Familia.pptx'
...
# ------------------------------------------------------------------------------
BLOQUES_NPS = [
    # Slide 4: Grupo Salinas por Agrupador (filtra TIPO Normal + Resonsable_N1)
    {'slide_index': 3, 'nivel_col': 'Agrupador', 'resp_col': 'Resonsable_N2',
     'filtros': [('TIPO', 'Normal'), ('Resonsable_N1', 'RICARDO BENJAMIN SALINAS PLIEGO')],
    ...
    # Slide 6: Negocios Familia por Nivel 4 (filtra TIPO Normal + Agrupador)
    {'slide_index': 5, 'nivel_col': 'Nivel 4', 'resp_col': 'Resonsable_N4',
     'filtros': [('TIPO', 'Normal'), ('Agrupador', 'NEGOCIOS FAMILIA')],
     'etiqueta_total': 'Negocios Familiares - RBS',
     'grafico_barras': 'Grafico_bar_NF', 'grafico_dona': 'Grafico _don_NF',
     'tabla_dif': 'Tabla_DIF_NF', 'tabla_anterior': 'Tabla_ANTERIO_NF', 'sufijo_dona': 'NF'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slides 7, 8 y 9)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == NEGOCIOS FAMILIA.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'NEGOCIOS FAMILIA')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor',  'tabla': 'Tabla_PRO_MENS_NF'},
    {'slide_index': 7, 'categoria': 'Pasivo',    'tabla': 'Tabla_PAS_MENS_NF'},
    {'slide_index': 8, 'categoria': 'Detractor', 'tabla': 'Tabla_DET_MENS_NF'},
]

# (Lista usada por el matcheo de colores; compartida con el proyecto principal)
GRUPOS_ORDENADOS = ['NEGOCIOS FAMILIA']
