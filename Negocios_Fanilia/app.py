# ==============================================================================
# APP WEB DEL REPORTE NEGOCIOS FAMILIA
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Negocios_Fanilia):
...
st.set_page_config(page_title="Reporte Negocios Familia", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Negocios Familia")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Negocios Familia_{trimestre} {anio}.pptx",
    )
