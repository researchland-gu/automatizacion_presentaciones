# ==============================================================================
# APP WEB DEL REPORTE UPAX
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Upax):
...
st.set_page_config(page_title="Reporte Upax", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Upax")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Upax_{trimestre} {anio}.pptx",
    )
...
with st.expander("Opciones avanzadas (plantilla)"):
    ...
    st.caption(f"El histórico UPAX del slide 8 actualiza el Excel: {config.FILE_HISTORICO_UPAX}")
