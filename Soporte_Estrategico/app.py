# ==============================================================================
# APP WEB DEL REPORTE SOPORTE ESTRATÉGICO
#
# Cómo correrla (desde la terminal de PyCharm, dentro de la carpeta Soporte_Estrategico):
...
st.set_page_config(page_title="Reporte Soporte Estratégico", page_icon="📊", layout="centered")

st.title("📊 Generador de Reporte Soporte Estratégico")
...
with col2:
    output_pptx = st.text_input(
        ...
        value=f"Reporte Soporte Estratégico_{trimestre} {anio}.pptx",
    )
