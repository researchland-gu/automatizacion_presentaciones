# ==============================================================================
# CONFIGURACIÓN CENTRAL DEL REPORTE SOPORTE ESTRATÉGICO
# Este es el ÚNICO archivo que necesitas editar cada trimestre:
#   1. Actualiza las rutas de FILE_ACTUAL / FILE_ANTERIOR
#
# Plantilla oficial: 'IPN_Colaboradores_Soporte Estratégico_automatizada.pptx'
# (OJO: vive directamente en Automatizaciones_PPT, sin subcarpeta).
# El reporte cubre: NPS Grupo Salinas (slide 4, shapes SL), NPS Soporte
# Estratégico (slide 6, shapes SE) y menciones Top 10 con rubro
# Tabla_PRO/PAS/DET_MENS_SE (slides 7-9).
#
...
TEMPLATE_PPTX = r'E:\Users\954108\Desktop\Satisfaccion  y Asuntos Publicos\Automatizaciones_PPT\IPN_Colaboradores_Soporte Estratégico_automatizada.pptx'
OUTPUT_PPTX = 'Reporte_Soporte_Estrategico.pptx'
...
BLOQUES_NPS = [
    ...
    # Slide 6: Soporte Estratégico por Nivel 3 (filtra TIPO Normal + Agrupador;
    # etiqueta total en mayúsculas, fiel al original)
    {'slide_index': 5, 'nivel_col': 'Nivel 3', 'resp_col': 'Resonsable_N3',
     'filtros': [('TIPO', 'Normal'), ('Agrupador', 'SOPORTE ESTRATÉGICO')],
     'etiqueta_total': 'SOPORTE ESTRATÉGICO - RBS',
     'grafico_barras': 'Grafico_bar_SE', 'grafico_dona': 'Grafico _don_SE',
     'tabla_dif': 'Tabla_DIF_SE', 'tabla_anterior': 'Tabla_ANTERIO_SE', 'sufijo_dona': 'SE'},
]

# ------------------------------------------------------------------------------
# MENCIONES TOP 10 CON RUBRO (slides 7, 8 y 9)
# Una tabla por slide: motivo (color según lista), menciones (color) y
# rubro (gris). Filtro fijo del reporte: Agrupador == SOPORTE ESTRATÉGICO.
# ------------------------------------------------------------------------------
FILTRO_MENCIONES = ('Agrupador', 'SOPORTE ESTRATÉGICO')
TOP_N_MENCIONES = 10

BLOQUES_MENCIONES_RUBRO = [
    {'slide_index': 6, 'categoria': 'Promotor',  'tabla': 'Tabla_PRO_MENS_SE'},
    {'slide_index': 7, 'categoria': 'Pasivo',    'tabla': 'Tabla_PAS_MENS_SE'},
    {'slide_index': 8, 'categoria': 'Detractor', 'tabla': 'Tabla_DET_MENS_SE'},
]

# (Lista usada por el matcheo de colores; compartida con el proyecto principal)
GRUPOS_ORDENADOS = ['SOPORTE ESTRATÉGICO']
